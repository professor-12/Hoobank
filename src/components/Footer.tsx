const Links = {
    ...
    batchthree: [
        { href: "/", content: "Our Patner" },
        { href: "/", content: "Become a Partner" },
    ],
};
        ...
        <>
            <div className="md:flex justify-between py-20">
                ...
                <div className="flex md:w-[60%] justify-between md:py-0 py-12">
                    ...
                    <div className="text-muted space-y-4">
                        <h4 className="text-white">Patner</h4>
                        <ul className="space-y-5">
                            {Links?.batchthree?.map((link) => {
                                return (
                                    <li
                                        key={link.content}
                                        className="hover:text-teal-400 cursor-pointer"
            ...
            <div className="p-[.3px]  bg-slate-500/80" />
            <div className="flex justify-between py-12 text-white">
                <h1 className="text-lg">2021 HooBank. All Rights Reserved.</h1>
                <ul className="flex space-x-4">
                    <li>
                        <img src="/instagram.a54e883a.svg" alt="" />
                    </li>
                    <li>
                        <img src="/facebook.b1172216.svg" alt="" />
                    </li>
                    <li>
                        <img src="/twitter.8f349e28.svg" alt="" />
                    </li>
                    <li>
                        <img src="/linkedin.3be30c66.svg" alt="" />
                    </li>
                </ul>
            </div>
        </>
